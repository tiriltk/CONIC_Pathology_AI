...
#Apply border mask on type map
type_with_borders = type_img.copy()
type_with_borders[border_mask] = black_color #set border pixels to black

output_path = os.path.join(output_dir, "bordered_type_map.png")

cv2.imwrite(output_path, type_with_borders)
