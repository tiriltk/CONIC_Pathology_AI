...
#Conic
pearson("Conic 40x Epithelial", "SpaCET Malignant") #Pearson correlation HoverNet Conic Epithelial vs SpaCET Malignant: 
pearson("Conic 40x Connective", "SpaCET CAF") #Pearson correlation Hovernet Conic Connective vs SpaCET CAF: 
