...
out_dir = "/Volumes/Expansion/biopsy_results/pannuke/40x/datafiles_output_40x_best/output_border/Func116_ST_HE_40x_BF_01/wsi_border/correct_result/binary_maps_coreg_combined/"
...
img_int = type_img.astype(np.int16)

for type, bgr in colors.items():
    color_arr = np.array(bgr, dtype=np.int16)
    ...
    #With colors
    color_img = np.zeros_like(type_img)
