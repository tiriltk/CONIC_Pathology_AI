...
def eval_models(FOLD_IDX, imgs_load, tp_num, exp_name0, encoder_name0, exp_name1, encoder_name1, epoch_idx=30):
    valid_indices = range(len(imgs_load_array-1 ))

    checkpoint_path0 = f"/media/jenny/PRIVATE_USB/AugHoverData/pannuke_checkpoints_trained/checkpoints/batch_size_4/{exp_name0}/improved-net_{epoch_idx}.pt"
    ...
    checkpoint_path1 = f"/media/jenny/PRIVATE_USB/AugHoverData/pannuke_checkpoints_trained/checkpoints/batch_size_4/{exp_name1}/improved-net_{epoch_idx}.pt"
    ...
    output_dir = "/media/jenny/PRIVATE_USB/warwick_colab_results/Image_HE_MM218_C_300125_20x_BF_01/patches/20x/aug_hovernet/pannuke_checkpoints_results/batch_size_4/test_bgr_rgb_3/"
...
if __name__ == "__main__":
    ...
    if "monusac" in args.exp_name0:
        ...
        tile_path = "/media/jenny/PRIVATE_USB/pannuke/pannuke_images/selected_test_patches/" 
        ...
        folder_idx = int(args.split)
        tp_num = 6

    # labels = np.load(ann_path)
    # imgs_load = np.load(img_path)
    epoch_idx = 49
    eval_models(args.split, imgs_load, tp_num, args.exp_name0, args.encoder_name0, \
