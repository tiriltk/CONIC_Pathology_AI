...
parser.add_argument("--name", type=str, default="hover_paper_monusac_seresnext50", help="name of experiment")
...
def demo_basic(rank, world_size):
    ...
    if "pannuke" in args.name:
        imagenet = CoNICDatasetPanMon(img_path=f"data_pannuke/panNuke_split/split_{args.split}/images_train.npy", 
                                                ann_path=f"data_pannuke/panNuke_split/split_{args.split}/labels_train.npy",
