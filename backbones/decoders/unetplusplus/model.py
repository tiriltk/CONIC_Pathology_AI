...
from backbones.base import SegmentationModel, SegmentationHead, ClassificationHead
...
class UnetPlusPlus(SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder_tp = UnetPlusPlusDecoder(
        ...
        self.decoder_hv = UnetPlusPlusDecoder(
            encoder_channels=self.encoder.out_channels,
            decoder_channels=decoder_channels,
            n_blocks=encoder_depth,
            use_batchnorm=decoder_use_batchnorm,
        ...
        self.decoder_np = UnetPlusPlusDecoder(
            encoder_channels=self.encoder.out_channels,
            decoder_channels=decoder_channels,
            n_blocks=encoder_depth,
            use_batchnorm=decoder_use_batchnorm,
        ...
        self.segmentation_head_tp = SegmentationHead(
        ...
        self.segmentation_head_hv = SegmentationHead(
            in_channels=decoder_channels[-1],
            out_channels=2,
            activation=activation,
            kernel_size=3,
        ...
        self.segmentation_head_np = SegmentationHead(
            in_channels=decoder_channels[-1],
            out_channels=2,
            activation=activation,
            kernel_size=3,
