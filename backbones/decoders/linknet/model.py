...
from backbones.base import SegmentationHead, SegmentationModel, ClassificationHead
...
class Linknet(SegmentationModel):
    ...
    def __init__(
        ...
        self.decoder_tp = LinknetDecoder(
        ...
        self.decoder_hv = LinknetDecoder(
            encoder_channels=self.encoder.out_channels,
            n_blocks=encoder_depth,
            prefinal_channels=32,
            use_batchnorm=decoder_use_batchnorm,
        ...
        self.decoder_np = LinknetDecoder(
            encoder_channels=self.encoder.out_channels,
            n_blocks=encoder_depth,
            prefinal_channels=32,
            use_batchnorm=decoder_use_batchnorm,
