...
for train_indices, valid_indices in split_generator:
    train_cohorts = np.array(img_sources)[train_indices]
    valid_cohorts = np.array(img_sources)[valid_indices]
...
joblib.dump(splits, 'splits_10_fold.dat')
